...
namespace WinFormUI
{
    public partial class Dashboard : Form
    {
        ...
        private void LoadTestingData()
        {
            ...
            customer.CheckingAccount.AccountName = "Anna's Checking Account";
            customer.SavingsAccount.AccountName = "Anna's Savings Account";
        ...
        // LISTENER
        private SavingsAccount_TransactionApprovedEvent(object sender, string e)
        {
        ...
        // LISTENER
        private CheckingAccount_TransactionApprovedEvent(object sender, string e)
        {
